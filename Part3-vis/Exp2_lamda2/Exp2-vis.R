...
lamda01<-read.csv("MC_lamda2_01.csv") %>% 
  mutate(parameter=rep("lamda2=0.1",50))

lamda02<-read.csv("MC_lamda2_02.csv") %>% 
  mutate(parameter=rep("lamda2=0.2",50))

lamda03<-read.csv("MC_lamda2_03.csv") %>% 
  mutate(parameter=rep("lamda2=0.3",50))

lamda04<-read.csv("MC_lamda2_04.csv") %>% 
  mutate(parameter=rep("lamda2=0.4",50))
