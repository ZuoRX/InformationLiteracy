...
system.time({
  ...
  fig4_MMCA_data <- foreach(
    ...
    #.packages = c("igraph") 
    #多个进程共享的系统环境
  ) %dopar% get_rhoIA_by_ratio_theta(l1)
  stopCluster(cl)
})
...
write.csv(fig4_MMCA_data,"Exp5_ratio_theta/Exp5_ratio_theta.csv",row.names = F)


#fig4_MMCA_data<-read.csv("fig4_MMCA_data.csv")


# #ratio=0.5   rhoA随theta的变化
# temp<-fig4_MMCA_data[,c(2,3,5)] %>% 
#   purrr::set_names("ratio","theta","rho_A") %>% 
#   subset(ratio==1)
# 
# ggplot(temp,aes(x=theta,y=rho_A,color="red"))+
#   geom_line()+
#   theme_few()+
...
#   guides(color="none")
# 
# ggsave("rhoA_theta.png",width=12, height=6,units="cm",dpi = 300)
# 
# # #1. rho_A
...
# # 
# # ggsave("rhoA.png",width=17, height=8,units="cm",dpi = 300)
# # 
# # 
# # 
# # #2. rho_I
...
# # 
# # ggsave("rhoI.png",width=17, height=8,units="cm",dpi = 300)
# # 
# # 
# # 
# # #3. rho_Ah
...
# # 
# # ggsave("rhoAh.png",width=17, height=8,units="cm",dpi = 300)
# # 
# # 
# # 
# # #4. rho_Ih
...
# # 
# # ggsave("rhoIh.png",width=17, height=8,units="cm",dpi = 300)
# # 
# # 
# # 
# # #5. rho_Al
...
# # 
# # ggsave("rhoAl.png",width=17, height=8,units="cm",dpi = 300)
# # 
# # 
# # 
# # #6. rho_Il
# # df<-fig4_MMCA_data[,c(2,3,10)] %>% 
...
# # 
# # ggsave("rhoIl.png",width=17, height=8,units="cm",dpi = 300)
# # 
# 
# 
# 
