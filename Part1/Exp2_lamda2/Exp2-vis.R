...
setwd("/home/zuo/zuo/Exp2_lamda2")

lamda01<-read.csv("lamda201/MMCA_fig3.csv") %>% 
  mutate(parameter=rep("lamda2=0.1",100))

lamda02<-read.csv("lamda202/MMCA_fig3.csv") %>% 
  mutate(parameter=rep("lamda2=0.2",100))

lamda03<-read.csv("lamda203/MMCA_fig3.csv") %>% 
  mutate(parameter=rep("lamda2=0.3",100))

lamda04<-read.csv("lamda204/MMCA_fig3.csv") %>% 
...
ggsave("rhoA.png",width=12, height=8,units="cm",dpi = 600)
...
ggsave("rhoI.png",width=12, height=8,units="cm",dpi = 600)
