...
write.csv(MMCA_fig3,"Exp2_lamda2/MMCA_lamda2_04.csv",row.names = F)
...
# 
# ggsave("Exp2_lamda2/betaU_fig3_MMCA.png",width=15, height=15,units="cm",dpi = 600)
# 
...
# 
# 
# ggsave("Exp2_lamda2/rhoI_betaU_fig3_MMCA.png",width=15, height=15,units="cm",dpi = 600)
